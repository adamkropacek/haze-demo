...
function showFormSuccess(form) {
  ...
  h3.textContent = 'Thank you. We will be in touch within 24 hours.';
  const p = document.createElement('p');
  p.appendChild(document.createTextNode('In the meantime you can call us on '));
  ...
  p.appendChild(tel);
  p.appendChild(document.createTextNode(' (Mon-Fri 7:00-17:00).'));
  wrap.appendChild(h3);
  wrap.appendChild(p);
...
(function(){
  ...
  lb.innerHTML='<button class="plb-close" aria-label="Close">×</button><button class="plb-nav plb-prev" aria-label="Previous">‹</button><img alt=""><button class="plb-nav plb-next" aria-label="Next">›</button><div class="plb-count"></div>';
